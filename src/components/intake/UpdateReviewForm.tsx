...
const FIELDS: FieldDef[] = [
  ...
  { key: "jobs", label: "Jobs (peak)", kind: "number" },
  { key: "avgWage", label: "Avg wage", kind: "number" },
  { key: "minAcreage", label: "Min acreage", kind: "number" },
  { key: "maxAcreage", label: "Max acreage", kind: "number" },
  { key: "minBuildingSqFt", label: "Min building sq ft", kind: "number" },
  { key: "maxBuildingSqFt", label: "Max building sq ft", kind: "number" },
  { key: "buildingSizeNeeds", label: "Building size", kind: "text" },
  { key: "electricityNeeds", label: "Electricity", kind: "text" },
  { key: "waterNeeds", label: "Water", kind: "text" },
  { key: "wastewaterNeeds", label: "Wastewater", kind: "text" },
  { key: "gasNeeds", label: "Gas", kind: "text" },
